defmodule PhxContextLearnWeb.CMS.PageController do
  ...
  def create(conn, %{"page" => page_params}) do
    IO.inspect conn.assigns.current_author
  ...
  def edit(conn, _) do
    changeset = CMS.change_page(conn.assign.page)
  ...
  defp authorize_page(conn, _) do
    page = CMS.get_pge!(conn.params["id"])
