defmodule PhxContextLearn.AccountsTest do
  use PhxContextLearn.DataCase

  alias PhxContextLearn.Accounts

  describe "users" do
    alias PhxContextLearn.Accounts.User
  ...
  describe "credentials" do
    alias PhxContextLearn.Accounts.Credential
